...
export function Card({ leftSide, cards }: Props) {
  ...
  return (
    <article className="flex justify-start items-start cm-2xl:items-center sm:gap-14 w-full lg:min-h-[600px] cm-2xl:h-full cm-2xl:flex-col bg-[#1F2124] border border-neutral-700 p-20 relative cm-1xl:p-5 cm-1xl:gap-10 cm-1xl:h-auto h-[650px]">
      <figure className="cm-1xl:hidden absolute top-0 right-[-15%] w-[130%] h-[1px] [background-image:_radial-gradient(at_center,_#FFDBB3,_#FFF7E41A);] animate-cm-dissapear [animation-timeline:view();] [animation-range:0%_1200px]" />
      <figure className="cm-1xl:hidden absolute bottom-0 right-[-15%] w-[130%] h-[1px] [background-image:_radial-gradient(at_center,_#FFDBB3,_#FFF7E41A);] animate-cm-dissapear [animation-timeline:view();] [animation-range:0%_400px]" />

      <figure className="cm-1xl:hidden absolute left-0 top-[-15%] h-[130%] w-[1px] [background-image:_radial-gradient(at_center,_#FFDBB3,_#FFF7E41A);] animate-cm-dissapear [animation-timeline:view();] [animation-range:0%_1200px]" />
      <figure className="cm-1xl:hidden absolute right-0 top-[-15%] h-[130%] w-[1px] [background-image:_radial-gradient(at_center,_#FFDBB3,_#FFF7E41A);] animate-cm-dissapear [animation-timeline:view();] [animation-range:0%_1200px]" />

      <div className="h-full flex flex-col justify-center items-center">
        <div className="absolute top-0 left-0 w-full h-full overflow-hidden">
          <figure className="cm-1xl:hidden [background-image:radial-gradient_at_center,_#8C5CF64D,_#F9741600)] w-64 h-64 absolute top-24 right-20 select-none z-0 blur-[80px] opacity-100" />
          <figure className="cm-1xl:hidden [background-image:radial-gradient(at_center,_#F974164D,_#F9741600)] opacity-60 w-64 h-64 absolute top-16 right-60 select-none z-0 blur-[80px]" />
          ...
          <figure className="cm-1xl:hidden [background-image:radial-gradient(at_center,_#F974164D,_#F9741600)] opacity-60 w-64 h-64 absolute top-32 right-80  cm-1xl:left-2 select-none z-0 blur-[80px]" />
          ...
          <figure className="cm-1xl:hidden [background-image:radial-gradient(at_center,_#8C5CF64D,_#F9741600)] w-64 h-64 absolute bottom-16 right-16 cm-1xl:right-2 select-none z-0 blur-[80px] opacity-100" />
        </div>
